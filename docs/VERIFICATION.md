...
- `gradlew runGameTestServer`: boots NeoForge 21.1.250 for Minecraft 1.21.1 and runs 15 in-world tests covering body/equipment/XP/spawn persistence, role/chat persistence, exactly-once death drops and same-UUID respawn, separately authorized teleport, cross-dimension portal ticket handoff and cleanup, native `/msg` coexistence and authority, world roster/cap/grants, progressive mining, placement, combat, food, chest-menu transfer, crafting-menu callbacks, and immediate stop.
