...
| Moving ticking chunks | 5×5 region per living companion; join-time bootstrap; saved tickets; orphan validation | No-player furnace test; baseline/1/5/10 distant-agent benchmark with exact 0/25/125/250 tickets and 20 TPS | No live ten-agent task benchmark | Vanilla server only |
