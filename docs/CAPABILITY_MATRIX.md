...
| Building / portals / mounts / creative / text | Single-block building and portal lifecycle only; mounts, creative, text absent | Placement and cross-dimension ticket handoff GameTests | Live takeover placement only | Unknown beyond vanilla placement/portal lifecycle |
