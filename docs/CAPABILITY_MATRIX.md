...
| Combat / food | Dedicated melee context; 20-tick ranged draw with companion-owned vanilla arrows, ammo/durability costs, cancellation; damageable body; food callbacks | Melee damage, ranged attribution/cost, mid-draw stop, and food consumption GameTests | No | Vanilla items/entities only |
...
| Containers and workstations | Revision transaction core plus real chest and crafting menu sessions; explicit 3×3 recipe-pattern primitive | Chest deposit, single-ingredient crafting, and shaped wooden-pickaxe recipe GameTests | No | Vanilla chest/table proof; automatic recipe planning remains partial |
